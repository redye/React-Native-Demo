		...
		return (
			<View ref={(user) => {this.user = user;}} style={styles.userContainer} {...panProps}>
				<View style={styles.userPanel}>
					<Image style={[styles.banner, {top: this.state.bannerTop}]} source={require('./../image/banner.png')} />
					...
					<View style={styles.userControl}>
						<TouchableHighlight style={styles.controlIcon}>
							<Icon name='gear-a' color='#8999a5' size={20} />
						</TouchableHighlight>
						<TouchableHighlight style={styles.controlBtn}>
							<Icon name='person-stalker' color='#8999a5' size={20} />
						</TouchableHighlight>
			        ...
			        {this.state.bannerTop<=0?<View></View>:<Image style={[styles.banner,{top: this.state.bannerTop}]} source={require('./../image/banner.png')}></Image>}
		          	{this.state.bannerTop<=0?<View></View>:<Image style={[styles.banner,{top: this.state.bannerTop, opacity:this.state.opacity}]} source={require('./../image/bannerBlur.png')}></Image>}
				...
				<ScrollView contentInset={{top:0}} style={styles.detailScroll} scrollEnabled={this.state.scrollEnabled}>
					<View style={{width:Util.size.width,backgroundColor:"#f5f8fa"}}>
		            	<Image style={{width:Util.size.width, height:0.835*Util.size.width, resizeMode:"contain"}} source={require('./../image/moreinfo.png')}></Image>
		          	</View>
				</ScrollView>
			</View>
		);
