...
class Weather extends Component {
	...
	render() {
				...
				return (
					<View key={dayElem.key} style={styles.withinWeekLine}>
						...
						<View style={styles.withinWeekIcon}>
							<Icon name={dayElem.icon} style={styles.withinWeekIconIcon}></Icon>
						</View>
		...
		// showsButton 是位于中间位置的 < 和 > 按钮
		// paginationStyle 将与默认 style 合并的自定义 style， 这里针对的是底部指示器的 style
 		return (
			<View>
				<Swiper 
...
const styles = StyleSheet.create({
	...
	weatherOtherValue: {
		width: Util.size.withinWeekLowNight / 2,
		paddingLeft: 15,
		flex: 1,
		fontSize: 15,
		color: '#fff',
